...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["openBlock"])(), Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createElementBlock"])("div", _hoisted_1, [Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createElementVNode"])("div", {
    ...
    default: Object(external_commonjs_vue_commonjs2_vue_root_Vue_["withCtx"])(() => [Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createElementVNode"])("div", {
      ...
      _: 3
    }, 8, ["data", "props", "horizontal", "labelStyle", "collapsable", "renderContent", "selectedKey", "defaultExpandLevel", "selectedClassName", "labelClassName", "vNodedrag", "focused", "onOnExpand", "onNodeClick", "onNodeDblclick", "onNodeMouseenter", "onNodeMouseleave", "onNodeContextmenu", "onNodeBlur"])], 2)]),
    _: 3
  ...
  }, null, 8, ["modelValue", "x", "y", "node", "data", "props", "menus", "disabled", "node-add", "node-delete", "node-edit", "node-copy", "onOnNodeFocus"])) : Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createCommentVNode"])("", true)], 512);
}
// CONCATENATED MODULE: ./src/components/tree-org/src/tree.vue?vue&type=template&id=0714b689&ts=true
...
const data2node = (data, level, context) => {
  const {
    id,
    label,
    pid,
  ...
  Object.keys(data).map(key => {
    if (['hidden', 'disabled', 'className', 'style'].includes(key)) cloneData[key] = data[key];
  });
  return { ...cloneData,
    id: data[id],
    label: data[label],
...
const renderLabel = (h, node, context, root) => {
  const {
    attrs
  } = context;
  ...
  return h('div', {
    ...
    placeholder: '请输入节点名称',
    value: node.label,
    onFocus: e => focusHandler && focusHandler(e, node),
    onInput: event => {
      node.$$data.label = event.target.value;
    },
    onBlur: e => {
      node.focused = false;
      blurHandler && blurHandler(e, node);
    },
...
const TreeOrgNode = (props, context) => {
  ...
  return renderNode(external_commonjs_vue_commonjs2_vue_root_Vue_["h"], nodeData, context, true);
};
...
const treeEmits = {
  ...
  'on-node-blur': (e, data, node) => e instanceof MouseEvent && isObject(node) && isObject(data),
  ...
  'on-node-focus': (e, data, node) => e instanceof MouseEvent && isObject(node) && isObject(data)
};
...
const useTree = (props, {
  ...
  const focusedId = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["ref"])(null);

  function nodeFocus(data) {
  ...
  const treeData = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["ref"])(props.data);
